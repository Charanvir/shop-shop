...
function Detail() {
  ...
  const addToCart = () => {
    ...
    if (itemInCart) {
      ...
      // if we are updating quantity, use existing data and increment purchaseQuantity value by one
      idbPromise('cart', 'put', {
        ...itemInCart,
        purchaseQuantity: parseInt(itemInCart.purchaseQuantity) + 1
      })
      ...
      // if product is not in cart yet, add it to the current shopping cart in IndexedDB
